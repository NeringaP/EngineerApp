...
INSERT INTO USER(ID, USERNAME, PASSWORD, ENABLED) VALUES(101, 'odeta', '$2a$10$ZVtIr19QnA/tJjRDhdXn/Ok/Wy0kh7PGI/KLwA.4JzX6y6FKN7TR2', 1);
INSERT INTO USER(ID, USERNAME, PASSWORD, ENABLED) VALUES(102, 'neringa', '$2a$10$ZVtIr19QnA/tJjRDhdXn/Ok/Wy0kh7PGI/KLwA.4JzX6y6FKN7TR2', 1);

INSERT INTO AUTHORITIES(ID, AUTHORITY, USER_ID) VALUES(1, 'CREATOR', 101);
INSERT INTO AUTHORITIES(ID, AUTHORITY, USER_ID) VALUES(2, 'USER', 102);
